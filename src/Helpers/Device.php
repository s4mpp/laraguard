...
abstract class Device
{
    public static function browser(string $user_agent): ?string
    {
          $regex_arrays = [
            ...
            '/Chrome[\/\s](\d+\.\d+)/' => 'Chrome',
            '/CriOS[\/\s](\d+\.\d+)/' => 'Chrome',
            '/Firefox[\/\s](\d+\.\d+)/' => 'Firefox',
            '/FxiOS[\/\s](\d+\.\d+)/' => 'Firefox',
            '/Safari[\/\s](\d+\.\d+)/' => 'Safari',
          ];

          foreach ($regex_arrays as $regex => $value) {
